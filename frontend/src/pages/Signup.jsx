...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-indigo-600/10 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md relative animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-dark-400 mt-1">Join TruthFeed and fight misinformation</p>
        </div>
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="text-sm text-dark-300 font-medium mb-1 block">Username</label>
              <input
                type="text"
                value={username}
